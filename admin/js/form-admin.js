(function( $ ) {
	...
	$(document).ready(function() {
		...
		$('#save_degree_form').click(function(e) {
			e.preventDefault();
		...
		$('#save_tc_cc_form').click(function(e){
			e.preventDefault();
			$( "button, input" ).prop( "disabled", true );
			$(".mlv_loading_btn").removeClass("d-none");
		...
		$('#save_studing_form').click(function(e){			
			e.preventDefault();
			$( "button, input" ).prop( "disabled", true );
			$(".mlv_loading_btn").removeClass("d-none");
		...
		$('#save_cdc_form').click(function(e){			
			e.preventDefault();
			$( "button, input" ).prop( "disabled", true );
			$(".mlv_loading_btn").removeClass("d-none");
		...
		$('#save_cdc_geo_form').click(function(e){			
			e.preventDefault();
			$( "button, input" ).prop( "disabled", true );
			$(".mlv_loading_btn").removeClass("d-none");
	...
	function add_degree_form_data_to_obj() {
		...
		var nonce = jQuery("#bt_fee_portal_order_form_meta_box #_wpnonce").val();
