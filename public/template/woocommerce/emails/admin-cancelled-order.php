...
<p><?php printf( esc_html__( 'Unfortunately, we have to cancel your order below' . $reason, 'woocommerce' ) ); ?></p>
<p><?php printf( esc_html__( 'If you have already paid, we would like to let you know that we have processed the refund.', 'woocommerce' ) ); ?></p>
<p><?php printf( esc_html__( 'We are so sorry for the inconvenience caused and appreciate your understanding.', 'woocommerce' ) ); ?></p>
