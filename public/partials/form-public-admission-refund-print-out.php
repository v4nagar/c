...
<div class="MLV_gobv_form fontsize">
    ...
    <h4 class="text-center">
        ...
        Application Form of Refund For Admission Payment
    </h4>
    <table>
        <tr>
        ...
        <tr>
            <td style="padding:10px !important;">Father's Number :</td>
            <td><?= $fname ?></td>
        </tr>
        <tr>
            <td style="padding:10px !important;">Class :</td>
            <td><?= $class ?></td>
        </tr>
        <tr>
            <td style="padding:10px !important;">Application ID No. :</td>
            <td><?= $app_id ?></td>
        </tr>
        <tr>
            <td style="padding:10px !important;">Amount :</td>
            <td><?= $amount ?></td>
        </tr>
        <tr>
            <td style="padding:10px !important;">Bank Name :</td>
            <td><?= $bank_name ?></td>
        </tr>
        <tr>
            <td style="padding:10px !important;">Bank A/c Number :</td>
            <td><?= $bank_ac_num ?></td>
        </tr>
        <tr>
            <td style="padding:10px !important;">IFSC Code :</td>
            <td><?= $ifsc ?></td>
        </tr>
        <tr>
            <td style="padding:10px !important;">Account Holder Name :</td>
    ...
    <p class="m-0 p-0 text"><b>Note:- Attach PrintOut of Fess Receipt and Bank Passbook</b></p>
	<hr/>
