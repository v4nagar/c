...
<div class="MLV_gobv_form fontsize">
    ...
    <div class="row">
        ...
        <div class="col-12 ">
            <p>
                <b>Dear Sir,</b><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please issue my <b>Studying Certificate</b>
                & oblige.<br>
    ...
    <table class=" pt-0 m-0 border border-dark border-1">
        <thead>
            <tr>
                ...
                <th class=" border border-dark border-1" scope="col">Result Pass/Fail</th>
                <th class=" border border-dark border-1" scope="col">Date of leaving the College</th>
            </tr>
        </thead>
        <tbody>
            <tr>
    ...
    <br>
    <div class="row ">
        <div class="col">Cashier's Signature </div>
    ...
    <p class="m-0 p-0 text"><b>Note:- Attach Photocopy of Mark Sheet of Final Year Examination of UG/PG and AADHAAR Card.</b>
    </p>
	<hr/>
