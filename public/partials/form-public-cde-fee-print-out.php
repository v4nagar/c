...
<div class="MLV_gobv_form fontsize">
    ...
    <div class="row">
        ...
        <div class="col-8 ">
            <p class="col m-0">Ref No. :
                <?= $order_id ?>/<?= $transaction_id ?>
            </p>
            <p class="col m-0">Paid Amount :
             <?= wc_price($order->get_total()); ?>
            </p>
            <p class="col m-0">Date :
                <?= $istDateCreated ?>
            </p>
            <p class="col m-0">Paid Through :
    ...
    <div id="app_body" class="row mt-2">
        ...
        <div class="col-12 ">
            <p>
                <b>Dear Sir,</b><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please accept the <b>Hard Copy of Examination Form</b> with IPG receipt of Non-Collegiate CDC fee & oblige.<br>
